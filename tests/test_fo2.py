...
def test_read_pre2025_file(fo2_pre2025_expected, fo2_pre2025_csv):
    ...
    """
    _check_scripps_files(expected_file=fo2_pre2025_expected, csv_file=fo2_pre2025_csv)


def test_read_v2025_file(fo2_v2025_expected, fo2_v2025_csv):
    """This test confirms that the reader for the Scripps O2 file format
    ...
    """
    _check_scripps_files(expected_file=fo2_v2025_expected, csv_file=fo2_v2025_csv)


def _check_scripps_files(expected_file, csv_file):
    curr_df = fo2_prep._read_o2n2_file(csv_file)
    expected_df = pd.read_csv(expected_file, parse_dates=['date']).set_index('date')
